...
- 10×10 画面按四个 5×5 象限组织 best EMA、epoch-100 raw、latest raw 和 RGB-only final raw；蓝、绿、橙边框分别标识 H4、H8、H16。
- README 内嵌自动循环 GIF，同时保留高清 MP4、机器可读选片清单和可复现构建脚本；原始 MP4 仍位于外部 Downloads，不进入 Git。
