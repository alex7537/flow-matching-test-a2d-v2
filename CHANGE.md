...
## 2026-09-16｜完善 A2D 评测闭环验收路线

- 审阅基线：`feat/a2d-eval-loop-v0@302d57b`。
- 扩充 `docs/A2D_EVAL_LOOP.md`：reset/首帧对齐、smoke 与恢复、有效覆盖、保持诊断、单变量任务单及阶段验收证据。
- 保持现有 H16/300/5cm 连续 5 次动作观测、有效分母和 L1 人工门禁；新增要求不冒充已实现能力。
- 本次仅修改文档，未启动仿真、观察器或训练，也未变更 lifecycle 账本。
